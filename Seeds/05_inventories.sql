USE NHT_Marine
GO
INSERT INTO [dbo].[Suppliers] ([Name], [Address], [ContactEmail], [ContactPhone])
VALUES 
...
GO
INSERT INTO [dbo].[StorageTypes] ([Name])
VALUES 
(N'Nhà kho'),
(N'Bể cá loại 1m2'),
(N'Bể cá mini'),
...
GO
INSERT INTO [dbo].[Storages] ([Name], [TypeId])
VALUES 
(N'Kho A', 1),
(N'Kho B', 1),
(N'Kho C', 1),
...
(N'Lỗi vận chuyển');
GO
INSERT INTO [dbo].[Inventories] ([StorageId], [ProductItemId], [Quantity])
VALUES
-- Kho 1
(1, 1, 25),
(1, 2, 50),
