...
VALUES
(N'Siêu ưu đãi dòng cám cao cấp', 
 N'Khuyến mãi 20% cho các sản phẩm AF- PRO CÁM, Arica cám và Boost Koi – Growth Color. Dành riêng cho mùa nuôi dưỡng cá tăng trưởng.', 
 20, '2025-08-01 00:00:00', '2025-08-10 23:59:59', 1, '2025-07-25 10:00:00', 1),

(N'Guppy mùa lễ hội', 
 N'Ưu đãi 25% cho dòng Cá 7 màu koi đỏ, koi đen và các loại cá Guppy khác. Mua càng nhiều càng giảm sâu!', 
 25, '2025-07-15 00:00:00', '2025-07-25 23:59:59', 1, '2025-07-10 09:00:00', 2),

(N'Khuyến mãi combo sản phẩm tăng trưởng', 
 N'Giảm 18% cho Boost Koi – Growth Color, AF- PRO CÁM và Arica cám khi mua combo 2 hoặc nhiều sản phẩm.', 
 18, '2025-08-12 00:00:00', '2025-08-20 23:59:59', 1, '2025-08-01 11:30:00', 2),

(N'Mua cá tặng yêu thương', 
 N'Chương trình giảm giá 15% khi mua bất kỳ sản phẩm trong nhóm: Cá 7 màu koi đỏ, Cá 7 màu koi đen, Ba ba. Áp dụng toàn quốc.', 
 15, '2025-07-20 00:00:00', '2025-07-30 23:59:59', 1, '2025-07-18 14:00:00', 1),

(N'Ưu đãi dinh dưỡng mùa hè', 
 N'Khuyến mãi 22% cho sản phẩm Boost Koi – Growth Color, AF- PRO CÁM, Arica cám trong tuần lễ chăm cá khỏe.', 
 22, '2025-08-18 00:00:00', '2025-08-24 23:59:59', 1, '2025-08-10 08:45:00', 2);
GO
INSERT INTO dbo.ProductsPromotions (PromotionId, ProductId)
VALUES
